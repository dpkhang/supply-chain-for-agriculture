...
const init = async () => {
    ...
    const contract = await new web3.eth.Contract(Coin.abi, '0x9Ce8480d35b4F29564F0613022fcD743de89efa7');
    ...
    //     ,gas: 3000000
    // }); //4
    const giaoDich = await contract.methods.DanhSachNhatKyDongRuong(5).call();
